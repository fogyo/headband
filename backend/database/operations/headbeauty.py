...
async def increase_super_tokens(session: AsyncSession, chat_id: int, amount: int):
    await TokenModel.add_super_tokens(session=session, chat_id=chat_id, amount=amount)
