...
from backend.api import create_categories, create_haircut_template, create_beards_template, create_hair_colors_template, \
    create_hair_perms_template, create_admin, create_cities_and_metro
...
from backend.api.admin import statistics, guide_moderation, support, control_panel, template_control
...
app.include_router(template_control.router)
