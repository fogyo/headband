...
def get_analyze_sync(file_url: str):
    ...
    - Поля должны быть именно такие: face_type, resume, eye_type, skin_color, jawline, forehead_height, cheekbones, neck_length, hair_color, beard_facial_features.
    - Все поля — строки (str).
    ...
    Пример ожидаемого ответа:
    {
      ...
      "beard_facial_features": "Мужчина с широким основанием носа. Аккуратный подбородком."
    }
    """
    ...
    try:
        ...
        required_fields = {'face_type', 'resume', 'eye_type', 'skin_color', "jawline", "forehead_height", "cheekbones", "neck_length", "hair_color", "beard_facial_features"}
